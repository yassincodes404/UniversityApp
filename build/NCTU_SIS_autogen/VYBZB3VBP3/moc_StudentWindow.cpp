...
QT_MOC_LITERAL(3, 31, 8), // "onLogout"
QT_MOC_LITERAL(4, 40, 11) // "refreshData"

    },
    "StudentWindow\0logoutRequested\0\0onLogout\0"
    "refreshData"
};
...
void StudentWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StudentWindow::logoutRequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void StudentWindow::logoutRequested()
{
