...
QT_MOC_LITERAL(1, 13, 15), // "logoutRequested"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 8), // "onLogout"
QT_MOC_LITERAL(4, 39, 16), // "onCourseSelected"
...
void DoctorWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onCourseSelected((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (DoctorWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DoctorWindow::logoutRequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DoctorWindow::logoutRequested()
{
